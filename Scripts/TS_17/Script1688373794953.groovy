...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_Sauce Labs Backpackcarry.allTheThings()_da9c16'))
...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/body_You need to enable JavaScript to run t_f1c45d'))
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), 'fg')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'sd')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), 'df')
