...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), '3456')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), '234t')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), '234r')

WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_Sauce Labs Bolt T-ShirtGet your testing_0a02ba'))
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_Cancel'))

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), '456')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), '23')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), '2345')
