...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_29.99Add to cart'))
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/a_3'))
