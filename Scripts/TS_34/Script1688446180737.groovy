...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_Swag Labs'))
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), 'qwe')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'qwe')

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'))

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), 'qwe')
