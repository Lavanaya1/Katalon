...
WebUI.doubleClick(findTestObject('Page_Swag Labs/div_15.99Add to cart'))
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_Continue ShoppingCheckout'))
